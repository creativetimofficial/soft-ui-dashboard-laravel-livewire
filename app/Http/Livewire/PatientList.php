...
class PatientList extends Component
{
    ...
    public function mount()
    {
        ...
        $currentDate = Carbon::now()->toDateString(); // Gets the current date in 'YYYY-MM-DD' format

        // Load patient data in chunks
        $this->patients = new Collection();
        $this->labResult = new Collection();
        ...
        DB::connection('mysql_hxp')->table('ovst as o')
            ...
            ->chunk(100, function ($patients) {
                ...
                $patientVns = $patients->pluck('vn'); // Extract the 'vn' values for the current chunk

                // Load lab results for the current chunk
