                    ...
                    <div class="card-body">
                            ...
                            <div>
                                ...
                                <div
                                    ...
                                    <input wire:model="passwordConfirmation" id="password" type="password"
                                        class="form-control" placeholder="passwordConfirmation" aria-label="Password"
                        ...
                        @if ($showSuccesNotification)
                            <div wire:model="showSuccesNotification"
                                ...
                                <span class="alert-text text-white"> Your password has been successfuly changed! You can
                                    login <a class="text-info" href="{{ route('login') }}">here</a></span>
