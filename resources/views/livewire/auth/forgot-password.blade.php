                    ...
                    <div class="card-header pb-0 text-left bg-transparent">
                        @if ($showDemoNotification)
                            <div wire:model="showDemoNotification"
                                ...
                                <span class="alert-text text-white"> You are in a demo version, you can't update the
                                    profile.</span>
                    ...
                    <div class="card-body">
                        ...
                        @if ($showSuccesNotification)
                            <div wire:model="showSuccesNotification"
                                ...
                                <span class="alert-text text-white"> An email for resetting your password has been
                                    sent!</span>
                        ...
                        @if ($showFailureNotification)
                            <div wire:model="showFailureNotification"
                                class="mt-3 alert alert-primary alert-dismissible fade show" role="alert">
                                <span class="alert-text text-white"> You are not registered as a user. Please sign up <a
                                        class="text-info" href="{{ route('sign-up') }}">here</a></span>
