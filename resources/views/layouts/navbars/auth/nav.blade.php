      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            <li class="breadcrumb-item text-md"><a class="opacity-5 text-dark" href="javascript:;">Pages</a></li>
            <li class="breadcrumb-item text-sm text-dark active text-capitalize" aria-current="page">{{ Route::currentRouteName() }}</li>
          </ol>
          <h6 class="font-weight-bolder mb-0 text-capitalize">{{ Route::currentRouteName() }}</h6>
        </nav>
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4 d-flex justify-content-end" id="navbar">
          <div class="nav-item d-flex align-self-end">
            <a href="#" class="btn btn-primary active mt-4" role="button" aria-pressed="true">
              <span class="pe-2 mt-3"><i class="ni ni-cloud-download-95 ni-lg mt-1"></i></span>
              Download
            </a>
          </div> 
