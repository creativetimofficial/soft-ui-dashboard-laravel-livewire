        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a href="https://www.creative-tim.com/product/soft-ui-dashboard-pro-laravel"
                    class="btn btn-primary btn-lg active mt-3" target="_blank" role="button" aria-pressed="true">
                    Upgrade to PRO</a>
            </li>
        </ul>
    </div>
        ...
        <div class="card card-background shadow-none card-background-mask-secondary" id="sidenavCard">
            ...
            <div class="card-body text-left p-3 w-100">
                ...
                <div class="docs-info">
                    ...
                    <a href="https://soft-ui-dashboard-laravel.creative-tim.com/documentation/" target="_blank"
